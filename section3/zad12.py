...
def plot_conchoid(a, filename=None):
    theta = np.linspace(-np.pi/2 + 0.01, np.pi/2 - 0.01, 1000)  # theta in (-pi/2, pi/2)
...
for a in a_values:
    plot_conchoid(a, f"wykresy/ex13_a_{a}.png")

plot_conchoid_for_all_a(a_values, "wykresy/ex13_all.png")
